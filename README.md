...
| ----------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| Chronomy                | Team project to create a curated TikTok web app                                                  | <div style="width:300px">Backend: Ruby on Rails, RSpec, Heroku<br>Frontend: React, Jest, Enzyme, Surge</div> | [Video](https://vimeo.com/fixationvideo/review/435076687/a701c1fcbe) |
